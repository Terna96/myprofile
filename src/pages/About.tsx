                ...
                <CardContent className="p-0">
                  <div className="aspect-square bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center">
                    <div className="w-32 h-32 bg-muted rounded-full flex items-center justify-center">
                      <span className="text-4xl font-bold text-muted-foreground">YN</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="glass-card shadow-medium">
                <CardContent className="p-8">
                  ...
                  <div className="space-y-4 text-muted-foreground">
                    <p>
                      Welcome! I'm a passionate creative professional with over 5 years of experience 
                    ...
                    <p>
                      ...
                      contributing to open-source projects, or enjoying a good book on design philosophy.
                    </p>
                  </div>
                </CardContent>
              </Card>
